...
t=0;
f=0;
hits=new TClonesArray("CRTRawhit",10000);// Array of CRTRawhits
h2d=new TClonesArray("CRT2Dhit",10000);; //Array of CRT2Dhits 
evs=new TClonesArray("CRTEvent",10000);; //Array of CRTEvents
trk=new TClonesArray("CRTTrack",10000);; //Array of CRTTracks
