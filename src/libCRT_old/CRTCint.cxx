...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CRTRunHeader*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CRTRunHeader", ::CRTRunHeader::Class_Version(), "CRTRun.h", 77,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CRTRun*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CRTRun", ::CRTRun::Class_Version(), "CRTRun.h", 32,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::PMTFlash*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("PMTFlash", ::PMTFlash::Class_Version(), "CRTReco.h", 20,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TPCEvent*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TPCEvent", ::TPCEvent::Class_Version(), "CRTReco.h", 42,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CRTReco*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CRTReco", ::CRTReco::Class_Version(), "CRTReco.h", 67,
